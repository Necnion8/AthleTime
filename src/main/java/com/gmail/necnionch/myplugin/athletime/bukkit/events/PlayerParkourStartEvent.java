...
public class PlayerParkourStartEvent extends ParkourPointEvent implements Cancellable {
    ...
    public PlayerParkourStartEvent(ParkourPlayer player, Parkour parkour, ParkourPoint point, @Nullable PlayerInteractEvent baseEvent) {
        super(parkour, point);
        this.player = player;
